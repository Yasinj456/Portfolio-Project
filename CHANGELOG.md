...
### Added
- Designed abstract class for my WorkoutRoutine component

### Updated
- Changed the design to include a WorkoutRoutineSecondary abstract class that implements WorkoutRoutine
- Implemented updateExercise using only kernel methods
- Added contains, totalVolume, and printRoutine
- Implemented equals and toString methods
